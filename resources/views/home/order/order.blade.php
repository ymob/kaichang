...
@section('con')
    <div class="row bg-progress">
        ...
        <div class="col-md-8" ><span>首页 > 订单列表</span></div>
        <div class="col-md-2"></div>
    </div>
    <div style="height:30px;"></div>
    <div class="row order-title">
        <div class="col-md-2 "></div>
        <div class="col-md-8"id="title1"><span>订单列表</span></div>
        <div class="col-md-2"></div>
    </div>
    ...
    <div class="row">
        <div class="col-md-2"></div>
        <div class="col-md-8">
            <div class="col-md-3 col-md-offset-9"><a class="btn btn-danger" href="{{ url('/order/submitOrder') }}" role="button" style="color:white;">&nbsp;提交订单&nbsp;</a></div>
        </div>
        <div class="col-md-2"></div>
    </div>
