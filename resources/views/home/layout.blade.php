        ...
        <div class="cd-user-modal-container">
            ...
            <div id="cd-signup"> <!-- 注册表单 -->
                <form class="cd-form">
                    {{ csrf_field() }}
                    <div class="form-group has-feedback">
                        <input type="text" name="name" class="form-control form_my" placeholder="请输入用户名" style="padding-left: 20px;">
                        <span class="glyphicon glyphicon-user form_ico form-control-feedback"></span>
                    </div>
                    <div class="form-group has-feedback">
                        <input type="password" name="password" class="form-control form_my" placeholder="请输入密码" style="padding-left: 20px;">
                        <span class="glyphicon glyphicon-lock form_ico form-control-feedback" style=""></span>
                    </div>
                    <div class="form-group has-feedback">
                        <input type="email" name="email" class="form-control form_my" placeholder="请输入邮箱" style="padding-left: 20px;">
                        <span class="glyphicon glyphicon-envelope form_ico form-control-feedback"></span>
                    </div>
                    <div class="row" style="margin-top: px;">
                        <div class="col-xs-8">
                            <input type="email" name="email" class="form-control form_my" placeholder="输入手机号" style="padding-left: 20px;">
                            <span class="glyphicon glyphicon-phone form_ico form-control-feedback"></span>
                        </div>
                        <div class="col-xs-4">
                            <button type="submit" class="btn btn-default btn-lg btn-block">获取验证码</button>
                        </div>
                    </div>
                    <div class="row" style="margin-top: 15px;">
                        <div class="col-xs-8">
                            <input type="email" name="email" class="form-control form_my" placeholder="输入验证码" style="padding-left: 20px;">
                        </div>
                    </div>
                    <div class="row" style="margin-top: 15px;">
                        <div class="col-xs-12">
